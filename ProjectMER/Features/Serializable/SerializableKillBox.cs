...
public class SerializableKillBox : SerializableObject, IIndicatorDefinition
{
    /// <summary>
    ...
    public override GameObject SpawnOrUpdateObject(Room? room = null, GameObject? instance = null)
    {
        ...
        primitive.NetworkMaterialColor = new Color(1f, 0f, 0f, 0.1f);
    ...
    public GameObject SpawnOrUpdateIndicator(Room room, GameObject? instance = null)
    {
        ...
        if (instance == null)
        {
            ...
            root.NetworkMaterialColor = new Color(1f, 0f, 0f, 0.5f);
        }
        else
        {
